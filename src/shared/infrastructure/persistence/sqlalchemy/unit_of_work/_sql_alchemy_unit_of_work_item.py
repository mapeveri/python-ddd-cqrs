...
class SqlAlchemyUnitOfWorkItem(UnitOfWorkItem):
    ...
    def _start(self) -> None:
        ...
        if session.info.get(self.__UPPER_TRANSACTION_SESSION_KEY) is None:
            self.__guard_current_session_is_not_upper_level_and_dirty(session)
    ...
    def __guard_current_session_is_not_upper_level_and_dirty(self, session: SignallingSession) -> None:
    ...
    def __void_transaction(self) -> None:
