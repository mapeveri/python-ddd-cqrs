...
from src.marketplace.event.infrastructure.services.events_provider.http_events_provider import (
    HttpEventsProvider,
)
from src.marketplace.event.infrastructure.services.events_provider.upsert_event_provider import (
    UpsertEventProvider,
)
...
class ProcessEventsProvider:
    ...
    def process(self) -> None:
        data: List = self.http_events_provider()
        events: List[Dict] = self.json_parse_events_provider(data)
