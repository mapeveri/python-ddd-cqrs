...
class EventCreatedDomainEvent(DomainEvent):
    ...
    @staticmethod
    def event_name() -> str:
        return "marketplace.v1.event.domain_event.event_created_domain_event"
    ...
    @classmethod
    def from_primitives(cls, payload: Dict[Any, Any]) -> EventCreatedDomainEvent:
        return cls(
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, EventCreatedDomainEvent):
