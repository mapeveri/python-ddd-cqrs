...
def upgrade():
    ...
    op.create_index(
        ...
        "event",
        ["provider_id", "provider_organizer_company_id"],
        unique=True,
        postgresql_where=sa.text("provider_organizer_company_id IS NOT NULL"),
    )
    op.create_index(
        ...
        ["provider_id"],
        unique=True,
        postgresql_where=sa.text("provider_organizer_company_id IS NULL"),
    )
    op.create_table(
        "outbox",
